jQuery(document).ready(function ($) {
    ...
    $('.first-section .bottom-image, .second-section .background-image, .third-section .background-image, .fifth-section .background-image, .mobile-third-section .background-image').each(function () {
        var $e = $(this);
