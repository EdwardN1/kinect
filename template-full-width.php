        ...
        <main class="main small-12 medium-12 large-12 cell" role="main">
            ...
            <?php if (have_posts()) : while (have_posts()) :
                ...
                <div class="forth-section">
                    ...
                    <div class="background-image">
                        ...
                        <div class="chart">
                            ...
                            <div class="a-panel panel-1"><img src="<?php echo $forth_section_chart_panel_1['url'] ?>"></div>
                            <div class="panel-arrow-1 show-for-large"><img src="<?php echo $forth_section_chart_arrow['url'] ?>"></div>
                            <div class="panel-arrow-1 hide-for-large"><img src="<?php echo $mobile_sixth_section_chart_arrow['url'] ?>"></div>
                            <div class="a-panel panel-2"><img src="<?php echo $forth_section_chart_panel_2['url'] ?>"></div>
                            <div class="panel-arrow-2 show-for-large"><img src="<?php echo $forth_section_chart_arrow['url'] ?>"></div>
                            <div class="panel-arrow-2 hide-for-large"><img src="<?php echo $mobile_sixth_section_chart_arrow['url'] ?>"></div>
                            <div class="a-panel panel-3"><img src="<?php echo $forth_section_chart_panel_3['url'] ?>"></div>
                            <div class="a-panel panel-4"><img src="<?php echo $forth_section_chart_panel_4['url'] ?>"></div>
                            <div class="a-panel panel-5"><img src="<?php echo $forth_section_chart_panel_5['url'] ?>"></div>
                            <div class="a-panel panel-6"><img src="<?php echo $forth_section_chart_panel_6['url'] ?>"></div>
                            <div class="a-panel panel-7"><img src="<?php echo $forth_section_chart_panel_7['url'] ?>"></div>
                            <div class="a-panel panel-8"><img src="<?php echo $forth_section_chart_panel_8['url'] ?>"></div>
                            <div class="content">
                ...
                <div class="mobile-ninth-section hide-for-large">
                    <div class="frame">
                        <div class="form">
                            <?php gravity_form(2, true, true, true, '', true, 12); ?>
                        </div>
                    </div>
                </div>
